...
mixin _$RepeaterDetailsSheetState {
  ...
  int get hashCode => Object.hash(
      runtimeType, repeater, feedbackStats, isFavorite, isTogglingFavorite);

  @override
  String toString() {
    return 'RepeaterDetailsSheetState(repeater: $repeater, feedbackStats: $feedbackStats, isFavorite: $isFavorite, isTogglingFavorite: $isTogglingFavorite)';
  }
}
...
extension RepeaterDetailsSheetStatePatterns on RepeaterDetailsSheetState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Repeater repeater, RepeaterFeedbackStats? feedbackStats,
            bool isFavorite, bool isTogglingFavorite)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
